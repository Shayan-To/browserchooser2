...
Imports System.Net
Imports BC2_Common.GeneralUtilities
...
Public Class StartupLauncher
    ...
    Sub New()
        Globals.gSettings = New Settings
...
#Region "Read-only Properties"
    ...
    Private Sub ProcessParts(ByVal aParts As GeneralUtilities.URLParts)
        ...
        If aParts.isProtocol = TriState.True Then
            For Each lProtocol In Globals.gSettings.Protocols
        ...
        ElseIf aParts.isProtocol = TriState.False Then 'is extention            
            For Each lFileType In Globals.gSettings.FileTypes
            ...
            Next
        Else 'use default
            'TODO: BREAK THIS OUT INTO A SEPERATE THREAD - COULD CAUSE LOAD DELAYS
            'just show all?
            For Each lProtocol In Globals.gSettings.Protocols
...
#Region "ShortURL deshortening"
    ...
    Private Sub mWorker_DoWork_HTTP()
        ...
        Try
            ...
            lRequest.UserAgent = Globals.gSettings.UserAgent
