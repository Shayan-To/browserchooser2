...
Public NotInheritable Class frmAbout
    ...
    Private Sub About_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        LabelVersion.Text = String.Format("Version {0} {1}", My.Application.Info.Version.ToString, BC2_Common.Globals.CurVersionDisplay)
        LabelCopyright.Text = String.Format("{0}, Under Ms-PL", My.Application.Info.Copyright)

        lblContributors.Text =
            "Guy Moreau" & Environment.NewLine &
            "J. Scott Elblein" & Environment.NewLine &
            "--------------------------------" & Environment.NewLine & Environment.NewLine &
            "Browser Chooser 1: " & Environment.NewLine & Environment.NewLine &
            "Original BC: Jan Ole Peek" & Environment.NewLine &
            "Development: shahineo" & Environment.NewLine &
            "Development: mwzero" & Environment.NewLine &
            "Development: StormPooper" & Environment.NewLine &
            "Logo & Icon: Kukag"

        lblAttributions.Text =
            "The only modification done to any of the projects is potentially signing of the code." & Environment.NewLine &
    ...
    Private Sub TabControl1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles TabControl1.SelectedIndexChanged
        ...
        Select Case TabControl1.SelectedIndex
            ...
            Case 3
                ...
                Dim lMessage As String = AddLine("", String.Format("Version {0} {1}", My.Application.Info.Version.ToString, BC2_Common.Globals.CurVersionDisplay))
                ...
                lMessage = AddLine(lMessage, StrDup(50, "-"))
                lMessage = AddLine(lMessage, String.Format("URL: {0}", Globals.gStartupLauncher.URL))

                For Each lSup As Guid In Globals.gStartupLauncher.SupportingBrowsers
                    'find this browser in the list
                    For Each lBRowser As Browser In Globals.gSettings.Browsers
...
#Region "Link Labels"
    ...
    Private Sub LinkLabel_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles llHome.LinkClicked, llLicense.LinkClicked
        ...
        End If
        ' Launch link
        BC2_Common.Globals.Launch(strLink, False)
    End Sub
    ...
    Private Sub llFactoryPack_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles llFactoryPack.LinkClicked
        BC2_Common.Globals.Launch("http://www.codeproject.com/Articles/32617/Extracting-Icons-from-EXE-DLL-and-Icon-Manipulatio", False)
    End Sub
    ...
    Private Sub llOSVersionInfo_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles llOSVersionInfo.LinkClicked
        BC2_Common.Globals.Launch("http://www.codeproject.com/Articles/73000/Getting-Operating-System-Version-Info-Even-for-Win", False)
    End Sub

    Private Sub llSebCboLb_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles llSebCboLb.LinkClicked
        BC2_Common.Globals.Launch("http://www.codeproject.com/Articles/18971/A-Separator-Combo-List-Box", False)
    End Sub

    Private Sub llCPOL_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles llCPOL.LinkClicked
        BC2_Common.Globals.Launch("http://www.codeproject.com/info/cpol10.aspx", False)
    End Sub
